...
"In a way quota methods may be viewed as procedures complementary to
divisor methods. Divisor methods fix the rounding rule and adjust the divisor. Quota
methods fix the divisor and adjust the rounding rule." \cita{pukkelsheim2017}

Los métodos de quota se caracterizan por tener un divisor $Q > 0$ prefijado (típicamente la \textit{Hare-Quota}),
