...
Observamos que $ 0 \leq p_i < 1 \ \forall \ 1 \leq i \leq n$
...
respeten estas probabilidades es una condición definida por Grimmet en \cita{Grimmett01042004}:
...
\noindent Una manera de reformular el problema es pensar en buscar $X_i \in \{ 0,1 \} \ / \ \sum_{i=1}^{n}{X_i} = K \ \wedge \ \mathbb{E}[X_i] = p_i$. 
